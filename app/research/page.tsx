...
export default function ResearchPage() {
    return (
        <div className="flex h-full w-full bg-background-light dark:bg-background-dark text-slate-800 dark:text-slate-200 overflow-hidden selection:bg-primary selection:text-white">
            {/* Global Sidebar - Purple Structure */}
            <aside className="hidden md:flex w-20 lg:w-64 flex-col border-r border-white/5 bg-[#111818] z-20 transition-all duration-300">
                ...
                <div className="p-6 flex items-center gap-3 border-b border-white/5">
                    <div className="relative shrink-0">
                        <div className="bg-center bg-no-repeat bg-cover rounded-full h-10 w-10 ring-2 ring-primary/50" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuAnMzqdLVopK07YMs7NumiNsfYDVDMI1YX_jrlc6vLaB1_gCOSpiiyV7aTzj6tj_A5fAkr0aAgzzUNgWQPwXefa501VZEd0yLZfOOvHAIN0NIDQXmBfkSxmcWFamVNwvCK1yIPkkKO6rv4nq1Wnnv8vGRNco36bC3YM5IoRkKzJnMRhgpOA3y4dbkY4TsIxh6KFA8OlHZEKE6CaX9MhvHGCj3tZhEn2m9eYt1VUW0a-CHJyYEvqM23UI0VnrLd2pXIV1EYaDxwaRMny")' }}></div>
                ...
                {/* Navigation - Purple Structure */}
                <nav className="flex-1 flex flex-col gap-2 p-4">
                    <Link className="flex items-center gap-3 px-3 py-3 rounded-xl bg-primary/10 border border-primary/20 text-primary group transition-colors" href="#">
            ...
            <main className="flex-1 flex flex-col relative min-w-0">
                ...
                <header className="flex items-center justify-between px-8 py-6 z-10">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="glass-panel px-4 py-2 rounded-lg flex items-center gap-2 text-xs font-mono text-secondary border-secondary/20">
                ...
                <div className="flex-1 overflow-y-auto px-8 pb-32">
                    ...
                    <section className="mb-10">
                        ...
                        <div className="flex gap-4 overflow-x-auto pb-4 snap-x">
                            {/* Card 1 */}
                            <div className="glass-panel min-w-[280px] w-[280px] rounded-2xl p-4 flex flex-col gap-3 snap-start relative group cursor-pointer overflow-hidden border border-white/5 hover:border-secondary/30 transition-all hover:shadow-[0_0_20px_rgba(0,212,255,0.1)]">
                            ...
                            {/* Card 2 */}
                            <div className="glass-panel min-w-[280px] w-[280px] rounded-2xl p-4 flex flex-col gap-3 snap-start relative group cursor-pointer border border-white/5 hover:border-secondary/30 transition-all hover:shadow-[0_0_20px_rgba(0,212,255,0.1)]">
                                <div className="absolute top-0 right-0 p-3 opacity-0 group-hover:opacity-100 transition-opacity z-10">
                                    <span className="material-symbols-outlined text-white bg-black/50 rounded-full p-1 text-sm backdrop-blur-sm">play_arrow</span>
                                </div>
                                <div className="w-full aspect-video rounded-lg overflow-hidden relative">
                                    <div className="absolute inset-0 bg-gradient-to-t from-background-dark/80 to-transparent"></div>
                                    <img className="w-full h-full object-cover opacity-80" alt="Cyberpunk style network graph nodes connection" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDqvJ-6FlFSTSeKrowaWn7bnpbm0fyIF-qhYeAg4Uo0ww858EPrWJ3pITRDsKO0DnadMpcDRlA14MecccFfFCAPMt4KQoGnuSItohUcHdmKtQf_nI-hafiTlZnCU5lHITkdcKrhiKFOAteeLTnGWHebvXMT-IC_ZwHeBBxzHYG3FODHe6pFETF_ti3YSJIT-HmmxnvNJDb2UTgQU2cOyHpsXcb2LB6hISdHPShZuDUlk6CeLheYMRX5oirKZXnH-NPVQTxWBtGYDK16" />
                                    <div className="absolute bottom-2 left-2 flex gap-2">
                            ...
                            <div className="glass-panel min-w-[280px] w-[280px] rounded-2xl p-4 flex flex-col gap-3 snap-start relative group cursor-pointer border border-white/5 hover:border-secondary/30 transition-all hover:shadow-[0_0_20px_rgba(0,212,255,0.1)]">
                                ...
                                <div className="w-full aspect-video rounded-lg overflow-hidden relative">
                                    <div className="absolute inset-0 bg-gradient-to-t from-background-dark/80 to-transparent"></div>
                                    <img className="w-full h-full object-cover opacity-80" alt="Abstract data sorting columns visualization" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCWx31t2K96AWzfIeynFw1k6fjQNBU-H7H8DdU8Ngg_iUFIvNunXn-VKqFfmSRBqYHjLB0VyJOudXchlch4ZciM6iq7uLWnqZPwLdGkm_nt8-r99EMpUpoQoRhXHagOT1DkL_YeOAdF0enZYT8g_EN6wkPEIVT3cpT17Y79hvVAZYzmdllovyiOIU3FgByRSOCXL6eHUu1KcyTU4QyFN6Z1rJgX9WKjQf4RoPILHbbyCMYyPLPXLTMEjf33BfNY1NPMmugMnI1j5HL2" />
                                    <div className="absolute bottom-2 left-2 flex gap-2">
                                        <span className="text-[10px] font-mono bg-black/60 text-secondary px-2 py-0.5 rounded border border-secondary/20">O(n log n)</span>
                                    </div>
                                </div>
                                <div>
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
                            {/* Folder Card 1 */}
                            <div className="glass-panel p-6 rounded-2xl flex flex-col justify-between h-48 relative overflow-hidden group cursor-pointer border border-white/5 hover:border-primary/50 transition-colors">
                            ...
                            {/* Folder Card 2 (Active) - Cyan Highlights */}
                            <div className="glass-panel p-6 rounded-2xl flex flex-col justify-between h-48 relative overflow-hidden group cursor-pointer border-secondary/30 hover:border-secondary/50 transition-colors">
                                ...
                                <div className="flex -space-x-2 z-10 mt-2">
                                    <div className="w-6 h-6 rounded-full border border-background-dark bg-cover bg-center" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCFWZUVVyhWLq19Onchmw9aAFeLtg6n6S8UFTvTU7uJtXbbd2bgglmANJT0LQZo_Oja_LPN01geRHkCnxCOOO55ZY0c6W909I0e5AO1m6cmb2vka8JJS1mESPGjWbWLdv1ICzdfO-66aG59FCq5nrrPqlaPzKDGym2dBl4-78aOqpCH3BXvsSXv4FPu3cFyGokTsFk5xKls4quKXEPS2FM_Wsumda0PNkS4-aE_Uaewcu9pQBzBFr9x_dTi6AMjSYznyaPXvOvDUsNn")' }}></div>
                                    <div className="w-6 h-6 rounded-full border border-background-dark bg-cover bg-center" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuAGYw58BpjoZ2d0bjVIQ_lQLHrw-UzTjKJSpdBZFTpWaGu8eW-E2cykCH5OsSkOuaf1CfiH7MQAOVJtFHej21PVF4SoBtdvgBy2wkAu7DOxeyk4EFX6WspHjhCqsWWbReu-KIeiy-slvceWEUakCTEHc_5We7_zy8GCxIcfVsB17g9esc1g276JXsoUlHKcfRu3MvHQvXkCrxy0ORszNlxhQ_Tvg5TFxPLUk2qNtfVjRz5H-ts69q-b_9SUrAKOjS_DOov2eDIEGC4F")' }}></div>
                                </div>
                            </div>
                            {/* Folder Card 3 */}
                            <div className="glass-panel p-6 rounded-2xl flex flex-col justify-between h-48 relative overflow-hidden group cursor-pointer border border-white/5 hover:border-blue-500/50 transition-colors">
                ...
                {/* Quick Launch Bar (Bottom Floating) */}
                <div className="absolute bottom-8 left-0 right-0 flex justify-center z-50 pointer-events-none">
                    <div className="pointer-events-auto glass-panel px-2 py-2 rounded-2xl flex gap-3 shadow-2xl shadow-black/50 border border-white/10">
                        <button className="bg-primary hover:bg-primary/90 text-white font-bold px-6 py-3 rounded-xl flex items-center gap-2 transition-all shadow-[0_0_15px_rgba(127,19,236,0.4)]">
            ...
            {/* Right Sidebar (Insights) - Purple Structure */}
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-4">
                            <div className="relative h-12 w-12 flex items-center justify-center">
                                <svg className="h-full w-full rotate-[-90deg]" viewBox="0 0 36 36">
                                    ...
                                    <path className="text-primary drop-shadow-[0_0_3px_rgba(127,19,236,0.5)]" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" strokeDasharray="80, 100" strokeLinecap="round" strokeWidth="3"></path>
                                </svg>
                        ...
                        <div className="flex items-center gap-4">
                            <div className="relative h-12 w-12 flex items-center justify-center">
                                <svg className="h-full w-full rotate-[-90deg]" viewBox="0 0 36 36">
                                    <path className="text-white/10" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" strokeWidth="3"></path>
                                    <path className="text-secondary drop-shadow-[0_0_3px_rgba(0,212,255,0.5)]" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" strokeDasharray="45, 100" strokeLinecap="round" strokeWidth="3"></path>
                                </svg>
